...
import { FaShieldAlt, FaCalculator, FaUsers } from "react-icons/fa";
      ...
      <main>
        ...
        <section id="inicio" className="hero">
          ...
          <div className="hero-content">
            ...
            <p>
              Acompañamos a empresas, comercios, profesionales y emprendedores
              con soluciones contables, impositivas, financieras y de seguros.
              Contabilidad · Impuestos · Gestión · Seguros Encontrá la solución
        ...
        <section id="nosotros" className="section">
          ...
          <p>
            Te acompañamos de forma integral, acompañando tu crecimiento y
            resolviendo tus necesidade con compromiso y seriedad. Vos te ocupás
            de tu negocio y nosotros de la gestión diaria
          </p>
        </section>
        ...
        <section id="servicios" className="section">
          ...
          <div className="services">
            <div className="service">
              ...
              <p>
                Te asesoramos para encontrar coberturas adecuadas a tus
                necesidades.
              </p>
            </div>
            ...
            <div className="service">
              ...
              <p>
                Elaboramos balances contables y brindamos información para la
                toma de decisiones.
              </p>
            </div>
            ...
            <div className="service">
              ...
              <p>
                Gestionamos la liquidación de haberes y las obligaciones
            ...
            <div className="service">
              ...
              <p>
                Elaboración de contratos, actas, notas y otros documentos
                administrativos.
              </p>
            </div>
          </div>
        ...
        <section id="contacto" className="section contact">
          ...
          <p>Solicita asesoramiento. Contactanos.</p>

          <button onClick={() => setMostrarFormulario(true)}>CONTACTAR</button>
