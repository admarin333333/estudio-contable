...
const novedades = [
  {
    ...
    ruta: "/novedades/monotributo-2026",

    contenido: [
      "En este artículo encontrarás información sobre las categorías del Monotributo 2026.",
